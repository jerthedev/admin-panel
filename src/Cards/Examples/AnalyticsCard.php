 ...
 * Nova-compatible card functionality for analytics data display
 * with custom meta data, authorization logic, and data visualization.
 *
 * This serves as a reference implementation for developers creating
 * custom analytics cards in their Laravel applications.
 *
...
class AnalyticsCard extends Card
{
    ...
    {
        // Create a mock request for meta data generation
        $request = new Request;
